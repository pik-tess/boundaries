...
R package **boundaries**, version **1.0.0**
...
Braun J, Breier J, Stenzel F, Vanelli C (2024). _boundaries: Planetary Boundary Status based on LPJmL simulations_. R package version 1.0.0, <URL: https://github.com/PIK-tess/boundaries>.
